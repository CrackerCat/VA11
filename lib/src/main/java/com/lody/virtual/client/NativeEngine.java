...
public class NativeEngine {
    ...
    private final static String PKG_GAME_SKIPKILL[] = {"com.tencent.tmgp.sgame"};
    public static boolean GameKill(InstalledAppInfo appInfo) {
        if (appInfo == null)
            return false;
        for (String pkg:PKG_NEED_SKIPKILL) {
            if (TextUtils.equals(pkg, appInfo.packageName))
    ...
    public static boolean nativeLoad(String libPath,String funcName,String content){
        return O0O0O00OO0(libPath,funcName,content);
    }

    public static boolean nativeInitSocket(String appName,String unixPath){
        return O0OO000OO0(appName,unixPath);
    }

    public static native void O0OOO00OO0();

    public static native boolean O0O0O00OO0(String libPath,String funcName,String content);

    public static native boolean O0OO000OO0(String appName,String unixPath);
