...
public class VEnvironment {
    ...
    static {
        ...
        // Point to: /
        ROOT = ensureCreated(new File(host, "vroot"));/*根*/
        // Point to: /data/
        DATA_DIRECTORY = ensureCreated(new File(ROOT, "data"));/*data*/
        // Point to: /data/user/
        USER_DIRECTORY = ensureCreated(new File(DATA_DIRECTORY, "user"));/*user*/
        ...
        // Point to: /
        ROOT64 = ensureCreated(new File(host64, "vroot"));
        // Point to: /data/
